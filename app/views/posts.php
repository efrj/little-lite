...
<div class="row">
    ...
    <div class="col-md-6">
        <h3><a href="/post/detail/<?=$posts[$p]['id']?>"><?=strtoupper($posts[$p]['title'])?></a>
        </h3>
        <p>by <a href="/post/detail/detail/<?=$posts[$p]['id']?>">Litte Lite MVC Example</a></p>
        <p><?=$posts[$p]['body']?></p>
        <a class="btn btn-primary" href="/post/detail/<?=$posts[$p]['id']?>">Read More <i class="fa fa-angle-right"></i></a>
    </div>
</div>
<!-- /.row -->
<hr>
